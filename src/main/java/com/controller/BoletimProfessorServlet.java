...
public class BoletimProfessorServlet extends HttpServlet {
            ...
            switch (action) {
                case "read" -> {
                    ...
                    if (!idAluno.isEmpty()) {
                        ...
                        boletins = listarPorSala(turmaAno, nomeDisciplina);
                    }
    ...
    public void cadastrar(HttpServletRequest req) throws SQLException, ClassNotFoundException, ExcecaoDeJSP{
        ...
        temp = req.getParameter("observacao");
        String observacao = (temp != null && !temp.isBlank() ? temp.trim() : null);

        Boletim boletim = new Boletim(nota1, nota2, media, observacao, idAluno, idDisciplina);
    ...
    public void atualizar(HttpServletRequest req) throws SQLException, ClassNotFoundException, ExcecaoDeJSP{
        ...
        Boletim boletimAlterado = new Boletim(idBoletim, nota1, nota2, media, observacao, idAluno, idDisciplina);
    ...
    public List<BoletimViewDTO> listarPorSala(String turmaAno, String nomeDisiciplina) throws SQLException, ClassNotFoundException{
        try(BoletimDAO dao = new BoletimDAO()) {
