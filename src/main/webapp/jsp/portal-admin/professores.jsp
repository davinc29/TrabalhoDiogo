...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/portal-admin/professores.css" />
        ...
        <main>
            ...
            <div class="tabela-container">
                <table class="tabela-notas">
                    ...
                    <tr>
                        ...
                        <td class="action-box">
                            ...
                            <form action="<%=request.getContextPath()%>/admin" method="post" onsubmit="confirmarDelete(event)">
                                <input type="hidden" name="action" value="deleteProfessor" />
                                <input type="hidden" name="id" value="<%=professor.getId()%>" />
                                <button type="submit" class="action-btn">
                    ...
                    %>
                    <tr>
                        <td colspan="6"><p>Nenhum professor encontrado.</p></td>
                    </tr>
                    <%
                        }
                    %>
